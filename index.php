...
if(!isset($_COOKIE[$cookie_name])) {
   ...
   if($_COOKIE[$cookie_name]=='succesful'){
    echo '<script>alert("you have sign succesfully")</script>';}

    else if($_COOKIE[$cookie_name]=='fail'){
      echo '<script>alert("try to later")</script>';}
        ...
        <div class="sky">
            ...
            <div class="box">
                ...
                <div class="page">
                    ...
                    <div id="errorMsg"></div>
                    <div class="content">
                        <form class="login" name="loginForm"  method="GET" action="api-log.php" >
                        ...
                        <form class="signup" name="signupForm"  method="GET" action="api-sign.php"  >
