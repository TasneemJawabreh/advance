...
if(!isset($_COOKIE[$cookie_name])) {
   ...
   if($_COOKIE[$cookie_name]=='booked'){
    echo '<script>alert("your uber is booked successfuly")</script>';}

    else if($_COOKIE[$cookie_name]=='notbooked'){
      echo '<script>alert("your uber is not booked try again later")</script>';}
            ...
            <ul class="tm-site-nav-ul">
              ...
              <li class="tm-page-nav-item">
                <a href="#special" class="tm-page-link">
                  ...
                  <span style="font-family: Cursive;"> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;view charts</span>
                </a>
              </li>
              <li class="tm-page-nav-item">
        ...
        <main class="tm-main">
          <div id="drink" class="tm-page-content">
            ...
            <div id="cold" class="tm-tab-content">
              ...
              alert (day);
                ...
                <form action="api-best.php" method="GET" id="bestTime">
          ...
          <div id="about" class="tm-page-content">
            <div class="tm-black-bg tm-contact-form-container tm-align-right">
              <form action="api-bnow.php" method="GET" id="contact-form">
          ...
          <div id="special" class="tm-page-content">
            ...
            <div class="tm-black-bg tm-contact-form-container tm-align-right">
               <form class="chart" name="chart"  method="GET" action="chart.php" >
                            
                            <br><br>
                            <input type="submit" value="chart1"  style="font-family: Cursive;" />
                        ...
                        <form class="chart2" name="chart2"  method="GET" action="chart2.php" >
                            
                            <br><br>
                            <input type="submit" value="chart2"  style="font-family: Cursive;" />
